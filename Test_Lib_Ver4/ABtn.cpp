...
void ABtn::attachLongPress_AB_Start(callbackFunction newFunction)
{
  _longPressAB_StartFunc = newFunction;
}
void ABtn::attachLongPress_AB_Start(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramLongPressAB_StartFunc = newFunction;
  _longPressAB_StartFuncParam = parameter;
}

void ABtn::attachDuringLongPress_AB(callbackFunction newFunction)
{
  _duringLongPressAB_Func = newFunction;
}
void ABtn::attachDuringLongPress_AB(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramDuringLongPressAB_Func = newFunction;
  _duringLongPressAB_FuncParam = parameter;
}

void ABtn::attachLongPress_AB_Stop(callbackFunction newFunction)
{
  _longPressAB_StopFunc = newFunction;
}
void ABtn::attachLongPress_AB_Stop(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramLongPressAB_StopFunc = newFunction;
  _longPressAB_StopFuncParam = parameter;
}

/* ------------------------------- Button C+B ------------------------------ */

void ABtn::attachLongPress_CB_Start(callbackFunction newFunction)
{
  _longPressCB_StartFunc = newFunction;
}
void ABtn::attachLongPress_CB_Start(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramLongPressCB_StartFunc = newFunction;
  _longPressCB_StartFuncParam = parameter;
}

void ABtn::attachDuringLongPress_CB(callbackFunction newFunction)
{
  _duringLongPressCB_Func = newFunction;
}
void ABtn::attachDuringLongPress_CB(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramDuringLongPressCB_Func = newFunction;
  _duringLongPressCB_FuncParam = parameter;
}

void ABtn::attachLongPress_CB_Stop(callbackFunction newFunction)
{
  _longPressCB_StopFunc = newFunction;
}
void ABtn::attachLongPress_CB_Stop(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramLongPressCB_StopFunc = newFunction;
  _longPressCB_StopFuncParam = parameter;
}

/* ------------------------------- Button C+D ------------------------------ */

void ABtn::attachLongPress_CD_Start(callbackFunction newFunction)
{
  _longPressCD_StartFunc = newFunction;
}
void ABtn::attachLongPress_CD_Start(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramLongPressCD_StartFunc = newFunction;
  _longPressCD_StartFuncParam = parameter;
}

void ABtn::attachDuringLongPress_CD(callbackFunction newFunction)
{
  _duringLongPressCD_Func = newFunction;
}
void ABtn::attachDuringLongPress_CD(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramDuringLongPressCD_Func = newFunction;
  _duringLongPressCD_FuncParam = parameter;
}

void ABtn::attachLongPress_CD_Stop(callbackFunction newFunction)
{
  _longPressCD_StopFunc = newFunction;
}
void ABtn::attachLongPress_CD_Stop(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramLongPressCD_StopFunc = newFunction;
  _longPressCD_StopFuncParam = parameter;
}

/* ------------------------------- Button A+D ------------------------------ */

void ABtn::attachLongPress_AD_Start(callbackFunction newFunction)
{
  _longPressAD_StartFunc = newFunction;
}
void ABtn::attachLongPress_AD_Start(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramLongPressAD_StartFunc = newFunction;
  _longPressAD_StartFuncParam = parameter;
}

void ABtn::attachDuringLongPress_AD(callbackFunction newFunction)
{
  _duringLongPressAD_Func = newFunction;
}
void ABtn::attachDuringLongPress_AD(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramDuringLongPressAD_Func = newFunction;
  _duringLongPressAD_FuncParam = parameter;
}

void ABtn::attachLongPress_AD_Stop(callbackFunction newFunction)
{
  _longPressAD_StopFunc = newFunction;
}
void ABtn::attachLongPress_AD_Stop(parameterizedCallbackFunction newFunction, void *parameter)
{
  _paramLongPressAD_StopFunc = newFunction;
  _longPressAD_StopFuncParam = parameter;
}
...
void ABtn::_fsm(bool activeLevel)
{
  ...
  case ABtn::OCS_DOWN:
  {
    ...
    else if ((activeLevel) && (waitTime > _press_ms))
    {
      ...
      case ABtn::BTN_12:
      {
        if (_longPressAB_StartFunc)
          _longPressAB_StartFunc();
        if (_paramLongPressAB_StartFunc)
          _paramLongPressAB_StartFunc(_longPressAB_StartFuncParam);
        break;
      }
      case ABtn::BTN_32:
      {
        if (_longPressCB_StartFunc)
          _longPressCB_StartFunc();
        if (_paramLongPressCB_StartFunc)
          _paramLongPressCB_StartFunc(_longPressCB_StartFuncParam);
        break;
      }
      case ABtn::BTN_34:
      {
        if (_longPressCD_StartFunc)
          _longPressCD_StartFunc();
        if (_paramLongPressCD_StartFunc)
          _paramLongPressCD_StartFunc(_longPressCD_StartFuncParam);
        break;
      }
      case ABtn::BTN_14:
      {
        if (_longPressAD_StartFunc)
          _longPressAD_StartFunc();
        if (_paramLongPressAD_StartFunc)
          _paramLongPressAD_StartFunc(_longPressAD_StartFuncParam);
        break;
      }
      }
    }
  ...
  case ABtn::OCS_COUNT:
  {
    ...
    else if (_storeStatus <= MAX_BUTTON) // !!!
    {
      if ((waitTime >= _click_ms) || (_nClicks[_storeStatus - 1] == _maxClicks))
      {
  ...
  case ABtn::OCS_PRESS:
  {
    ...
    else
    {
      ...
      case ABtn::BTN_12:
      {
        if (_duringLongPressAB_Func)
          _duringLongPressAB_Func();
        if (_paramDuringLongPressAB_Func)
          _paramDuringLongPressAB_Func(_duringLongPressAB_FuncParam);
        break;
      }
      case ABtn::BTN_32:
      {
        if (_duringLongPressCB_Func)
          _duringLongPressCB_Func();
        if (_paramDuringLongPressCB_Func)
          _paramDuringLongPressCB_Func(_duringLongPressCB_FuncParam);
        break;
      }
      case ABtn::BTN_34:
      {
        if (_duringLongPressCD_Func)
          _duringLongPressCD_Func();
        if (_paramDuringLongPressCD_Func)
          _paramDuringLongPressCD_Func(_duringLongPressCD_FuncParam);
        break;
      }
      case ABtn::BTN_14:
      {
        if (_duringLongPressAD_Func)
          _duringLongPressAD_Func();
        if (_paramDuringLongPressAD_Func)
          _paramDuringLongPressAD_Func(_duringLongPressAD_FuncParam);
        break;
      }
      }
    }
  ...
  case ABtn::OCS_PRESSEND:
  {
    ...
    case ABtn::BTN_12:
    {
      if (_longPressAB_StopFunc)
        _longPressAB_StopFunc();
      if (_paramLongPressAB_StopFunc)
        _paramLongPressAB_StopFunc(_longPressAB_StopFuncParam);
      break;
    }
    case ABtn::BTN_32:
    {
      if (_longPressCB_StopFunc)
        _longPressCB_StopFunc();
      if (_paramLongPressCB_StopFunc)
        _paramLongPressCB_StopFunc(_longPressCB_StopFuncParam);
      break;
    }
    case ABtn::BTN_34:
    {
      if (_longPressCD_StopFunc)
        _longPressCD_StopFunc();
      if (_paramLongPressCD_StopFunc)
        _paramLongPressCD_StopFunc(_longPressCD_StopFuncParam);
      break;
    }
    case ABtn::BTN_14:
    {
      if (_longPressAD_StopFunc)
        _longPressAD_StopFunc();
      if (_paramLongPressAD_StopFunc)
        _paramLongPressAD_StopFunc(_longPressAD_StopFuncParam);
      break;
    }
    }
    reset();
...
void ABtn::checkADC(void)
{
  ...
  /* ----------------------------------------------------------------------- */
  else if (tempADC >= DEFAULT_BTN_12_MIN && tempADC <= DEFAULT_BTN_12_MAX)
  {
    _status = ABtn::BTN_12;
  }
  else if (tempADC >= DEFAULT_BTN_32_MIN && tempADC <= DEFAULT_BTN_32_MAX)
  {
    _status = ABtn::BTN_32;
  }
  else if (tempADC >= DEFAULT_BTN_34_MIN && tempADC <= DEFAULT_BTN_34_MAX)
  {
    _status = ABtn::BTN_34;
  }
  else if (tempADC >= DEFAULT_BTN_14_MIN && tempADC <= DEFAULT_BTN_14_MAX)
  {
    _status = ABtn::BTN_14;
  }
  /* ----------------------------------------------------------------------- */
